            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="#activities">
                  <Button className="bg-white text-blue-700 hover:bg-gray-100 px-6">
                    Explore Our Activities
                    <ChevronRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link href="/contact">
                  <Button variant="outline" className="border-white text-white hover:bg-blue-700/30">
                    Contact Our Team
                  </Button>
                </Link>
              </div>
              ...
              <div className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 === 0 ? "" : "md:grid-flow-dense"}`}>
                <div className={index % 2 === 0 ? "order-2 md:order-1" : "order-2"}>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Link href="/contact">
                      <Button className="bg-blue-600 hover:bg-blue-700 text-white">Request Service</Button>
                    </Link>
                  </div>
                </div>
